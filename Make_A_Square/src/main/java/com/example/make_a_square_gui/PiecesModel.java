...
public class PiecesModel {
    ...
    {
        if(character=='Z') return pieces[0].clone();
        else  if(character=='I') return pieces[1].clone();
        else  if(character=='J') return pieces[2].clone();
        else  if(character=='L') return pieces[3].clone();
        else  if(character=='O') return pieces[4].clone();
        else  if(character=='S') return pieces[5].clone();
        else  if(character=='T') return pieces[6].clone();
