...
//    char[] arr = new char[]{'L','I','T','O','Z','J','S'};
    void setHashMap()
    {
        hashMap.put('Z',Integer.parseInt(textL.getText()));
        hashMap.put('I',Integer.parseInt(textZ.getText()));
        hashMap.put('J',Integer.parseInt(textI.getText()));
        hashMap.put('L',Integer.parseInt(textJ.getText()));
        hashMap.put('O',Integer.parseInt(textT.getText()));
        hashMap.put('S',Integer.parseInt(textS.getText()));
        hashMap.put('T',Integer.parseInt(textO.getText()));
    }
    ...
    void paintButton()
    {
        ...
        arrColor.add("-fx-background-color: #E9AB17;");
        arrColor.add("-fx-background-color: #AF7817;");
        arrColor.add("-fx-background-color: #82CAFF;");
